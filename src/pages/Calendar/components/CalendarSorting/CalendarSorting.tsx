...
export default function CalendarSorting() {
  const { academicYear, setAcademicYear } = useContext(CalendarContext)
  ...
  const handleChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    navigate({ pathname: `${mainPath.calendar}/${valueFromSelector}` })
  }
