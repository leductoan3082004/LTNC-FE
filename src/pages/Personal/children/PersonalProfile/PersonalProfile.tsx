      ...
      <div className='container'>
        ...
        <div className='border pt-10 items-center justify-center'>
          <div className='items-center justify-center flex pb-10 relative '>
            <div>
              <div className='inline-block h-14 w-14 absolute ml-36 mt-9 boder rounded-full border bg-gray-200 flex items-center justify-center ' onClick={handleClick} aria-hidden='true'>
            ...
            <div>
              <img className='rounded-full h-48 border-4' src='https://media.dolenglish.vn/PUBLIC/MEDIA/2b2f1391-7dcd-4d41-b1eb-2273c8cd00de.jpg' alt=''></img>
            </div>
