    ...
    <div className={className}>
      <div
        className={
          ...
          (errorMessage ? 'border-alertRed' : 'border-black/40')
        }
      >
        <span className='absolute right-2 top-1/2 -translate-y-1/2'>
          <svg
            ...
            viewBox='0 0 24 24'
            fill='currentColor'
            className='md:h-6 md:w-6 h-4 w-4 fill-primaryText duration-200'
          >
            {svgData}
          </svg>
        </span>
          ...
          >
            {visible && (
              <svg
                ...
                viewBox='0 0 24 24'
                fill='currentColor'
                className='md:h-6 md:w-6 h-4 w-4 fill-primaryTextUnHover hover:fill-primaryText'
              >
      ...
      <div className={'mt-1 min-h-[1.25rem] text-sm text-inforBlue ' + (!notifyMessage ? 'hidden' : '')}>
        {notifyMessage}
      </div>
    </div>
  )
